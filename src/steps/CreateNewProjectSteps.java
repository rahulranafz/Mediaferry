...
public class CreateNewProjectSteps {
    ...
    public void changeProductionStatus(WebDriver driver) throws InterruptedException {
        Thread.sleep(2000);
        createNewProjectPage.selectProductionStatus(driver, "14");
        createNewProjectPage.clickOnFinishedArtwork(driver);
    }

    public void uploadFinishedArtwork(WebDriver driver, SoftAssert softAssert, String filePath, String validationMsg){
        createNewProjectPage.clickOnFinishedArtwork(driver);
    ...
    public void acceptingUpload(WebDriver driver){
    ...
    public void submittingJob(WebDriver driver, SoftAssert softAssert, String projectName){
    ...
    public void uploadingAssetsWhileCreatingJob(WebDriver driver, SoftAssert softAssert, String filePath){
