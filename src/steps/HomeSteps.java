...
public class HomeSteps {
    ...
    public void goToActiveProjectsWithoutWait(WebDriver driver){
    ...
    public void uploadProfileSteps(WebDriver driver, String myProfilePath) throws InterruptedException {
