...
public class CreateNewProjectPage extends BasePage{
    ...
    public void clickOnCanvas(WebDriver driver){
        ...
        Action drawAction = builder.moveToElement(canvas,135,15).click().doubleClick().build();
        drawAction.perform();
    }
    ...
    public void clickOnProofingButton(WebDriver driver){
    ...
    public void acceptingWarnings(WebDriver driver){
        By warningAcceptanceLocator = By.xpath("//button[text()='Yes']");
    ...
    public void waitForSpinnerInvisibility(WebDriver driver){
