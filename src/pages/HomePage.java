...
public class HomePage extends BasePage {
    ...
    private By selectProfileLocator = By.name("file");
    ...
    public void clickOnActiveProjectsLnkWithoutWait(WebDriver driver){
    ...
    public void selectProfileImage(WebDriver driver, String myProfilePath){
        String fileUploaderPath = getWorkingDirectoryPath() + myProfilePath;
        driver.findElement(selectProfileLocator).sendKeys(fileUploaderPath);
    }
