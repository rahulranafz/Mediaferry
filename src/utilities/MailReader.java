...
public class MailReader {
	...
	public String FetchMails(String host, String username, String password, String sub) {
		...
		try {
			...
			try {
				...
				// System.out.println("Exception arise at the time of read
				// mail");
				ex.printStackTrace();
			}
	...
	public void printEnvelope(Message message) throws Exception {
		...
		if (subject.equals(expectedSubject)) {
			 ...
			 * System.out.println("Shyamjeet URL :"+
			 * content.substring(content.indexOf(
			 * "https://devso.mediaferry.com/mf-s40qa/login/activateUserNow/"),
			 * content.indexOf("'>")));
			 */
	...
	/*
	 * public static void main(String args[]) { MailReader mr = new
	 * MailReader(); String url = mr.FetchMails("imap.gmail.com",
